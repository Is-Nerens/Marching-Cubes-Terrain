...
& clang++ -std=c++20 -c "src\main.cpp" -I"$baseDir\libs\SFML\include" -I"$baseDir\libs\glew\include" 

# Link main.o and create the application executable
& clang++ -o build\application.exe main.o -I"$baseDir\libs\SFML\include" -I"$baseDir\libs\glew\include" -L"$baseDir\libs\SFML\lib" -L"$baseDir\libs\glew\lib\Release\x64" -lopengl32 -lglew32 -lsfml-graphics -lsfml-window -lsfml-system 
